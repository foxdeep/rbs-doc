...
- ➕ 建立：管理員可以向資源新增品項，指定品項名稱、庫存、價格和任何其他相關資訊等詳細資訊。
- 👀 讀取：「讀取」功能使管理員能夠查看有關每個品項的詳細信息，包括其屬性、狀態和關聯數據。
- 🖊️ 更新：管理員可以根據需要修改品項詳細信息，確保資訊保持準確和最新。這包括調整數量、更新條件或進行其他相關更改的能力。
- ❌ 刪除：如果某個品項不再使用或需要從資源中刪除，管理員可以輕鬆地將其從資源的品項清單中刪除，從而確保庫存組織良好且最新。
